                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>프로젝트에 투입되면서 처음 해보는 실무 업무에 실수하지않을까 긴장도 많이했지만, </p>
                                    <p>내가 고도화 및 개발 한 페이지에는 큰 에러가 나오지 않아서 다행이었다.</p>
                                    <p>새로운 기능은 적었고 고도화 하는 작업이 주 업무여서 학원에서 배웠던 이론들을 다시 한번 복습하고 실무에서 어떻게 이용되는지 알 수
                                        있었다.</p>
